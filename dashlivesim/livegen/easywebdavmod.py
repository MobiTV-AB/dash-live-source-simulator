"""
Source from easywebdav: https://github.com/amnong/easywebdav
...
Modified by Torbjorn Einarsson
Updated with an extra function uploaddata to avoid passing a filename or file object.
"""
...
class Client(object):
    ...
    def uploaddata(self, data, remote_path):
        self._upload(data, remote_path)
